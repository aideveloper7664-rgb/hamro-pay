...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`
          sidebar ${isOpen ? 'open' : ''} fixed md:sticky top-0 left-0 z-50
      ...
      >
        ...
        >
          <div className="user-avatar group-hover:scale-105 transition-transform">
            {avatarLetter}
          </div>
          <div className="user-info">
            <div className="user-name group-hover:text-[#ff4d6d] transition-colors">
              {displayName}
            </div>
        ...
        <div className="nav-list">
          ...
          >
            ...
            <span className="nav-label">Payment Links</span>
          </div>

          {/* Cashier Connect Group */}
          <div className={`nav-group ${expandedGroups.cashier ? 'expanded' : ''}`}>
            <div
              className={`nav-item ${expandedGroups.cashier ? 'expanded' : ''}`}
              onClick={() => toggleGroup('cashier')}
            >
              <span className="nav-icon orange">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <span className="nav-label">Cashier Connect</span>
              <span className="new-badge">New</span>
              <svg
                className={`chevron ${expandedGroups.cashier ? 'rotate-180' : ''}`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.4"
            ...
            <div className="sub-wrap">
              <div className="sub-inner">
                <div className="sub-list">
                  {/* FamPay */}
                  <div
                    className={`sub-item ${currentView === 'fampay' ? 'active' : ''}`}
                    onClick={() => handleNavClick('fampay')}
                  >
                    <span className="sub-icon yellow">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="sub-label">FamPay</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className={`nav-group ${expandedGroups.dev ? 'expanded' : ''}`}>
            <div
              className={`nav-item ${expandedGroups.dev ? 'expanded' : ''}`}
            ...
            >
              ...
              <span className="nav-label">Developer Portal</span>
              <span className="new-badge">New</span>
              <svg
                className={`chevron ${expandedGroups.dev ? 'rotate-180' : ''}`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.4"
            ...
            <div className="sub-wrap">
              <div className="sub-inner">
                <div className="sub-list">
                  <div
                    className={`sub-item ${currentView === 'developer' ? 'active' : ''}`}
                    onClick={() => handleNavClick('developer')}
                  >
                    <span className="sub-icon blue">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="sub-label">Hamro API</span>
                  </div>
                  <div
                    className="sub-item"
                    onClick={() => handleNavClick('developer')}
                  >
                    <span className="sub-icon purple">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="sub-label">API Integration</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Store Portal Group */}
          <div className={`nav-group ${expandedGroups.store ? 'expanded' : ''}`}>
            <div
              className={`nav-item ${expandedGroups.store ? 'expanded' : ''}`}
              onClick={() => toggleGroup('store')}
            >
              <span className="nav-icon pink">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <span className="nav-label">Store Portal</span>
              <span className="new-badge">New</span>
              <svg
                className={`chevron ${expandedGroups.store ? 'rotate-180' : ''}`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.4"
            ...
            <div className="sub-wrap">
              <div className="sub-inner">
                <div className="sub-list">
                  <div
                    className={`sub-item ${currentView === 'store' ? 'active' : ''}`}
                    onClick={() => handleNavClick('store')}
                  >
                    <span className="sub-icon pink">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="sub-label">My Store</span>
                  </div>
                  <div
                    className="sub-item"
                    onClick={() => handleNavClick('store')}
                  >
                    ...
                    <span className="sub-label">Customize Store</span>
                    <svg
                      className="lock"
                      viewBox="0 0 24 24"
                      fill="none"
                  ...
                  >
                    ...
                    <span className="sub-label">Store Settings</span>
                    <svg
                      className="lock"
                      viewBox="0 0 24 24"
                      fill="none"
          ...
          <div
            className={`nav-item highlight ${currentView === 'pricing' ? 'active' : ''}`}
          ...
          >
            ...
            <span className="nav-label">Upgrade Plan</span>
            <span className="new-badge">New</span>
          </div>

          {/* Refer & Earn */}
          <div
            className={`nav-item ${currentView === 'referral' ? 'active' : ''}`}
          ...
          >
            ...
            <span className="nav-label">Apply Promo</span>
          </div>
          ...
          <div
            ...
            onClick={() => handleNavClick('support')}
          >
            <span className="nav-icon indigo">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            <span className="nav-label">Agentic Support</span>
            <span className="new-badge">New</span>
          </div>
          ...
          >
            ...
            <span className="nav-label">Customize Page</span>
          </div>
          ...
          {/* Profile (highlighted) */}
          <div
            className={`nav-item highlight ${currentView === 'profile' ? 'active' : ''}`}
            style={{
          ...
          >
            <span
              className="nav-icon"
              style={{
                background: 'linear-gradient(135deg,rgba(255,30,75,0.18),rgba(255,30,75,0.06))',
